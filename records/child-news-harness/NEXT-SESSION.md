...
- 보고서: `records/child-news-harness/benchmark-one-screen-2026-08-11.md` (10기사 × 6설정 전문)
...
4. **프롬프트 착지점** — `web/features/f2-trade/lib/news-prompt.ts`가 맞지만,
   그 폴더는 `origin/mock_stock` 병합 대기 중이라 지금 만들면 충돌한다. 병합 후에 넣는다.
