...
const SHEET = styleFromCss(
  "position:absolute;left:0;right:0;bottom:0;height:82%;z-index:8;background:#F5F2F8;border-radius:28px 28px 0 0;" +
    ...
    <PhoneFrame>
      <div style={PAGE}>
        ...
        <div style={SCROLL}>
          ...
          <div onClick={() => setExpanded(true)} style={HOLD_CARD}>
        ...
        {expanded && (
          <>
            <div onClick={() => setExpanded(false)} style={SHEET_SCRIM} />
            <div style={SHEET}>
              ...
              >
                <div onClick={() => setExpanded(false)} style={SHEET_BACK}>
                  ‹
                </div>
