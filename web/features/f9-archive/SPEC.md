...
> **미결**: `docs/영웅키움_기획_통합문서_v2.md` 의 종목 추천 레드라인은 아직 이 변경을 반영하지 못했다. 그 문서는 이재용 세션만 고칠 수 있다 — 다음 이재용 세션에서 레드라인을 "LLM 발화 금지 / 화면 고정 목록 허용" 으로 갈라 적어야 이 SPEC 과 통합문서가 같은 말을 한다.
