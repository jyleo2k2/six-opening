-- selected-company-news-2026-08-15-deep-with-manual
...
cross join (
  values
    ...
    (
      'a91272017c63a2058a8924a14b4d9d2cfda87374781a5800681acdf18fb57a84', 'MANUAL-1CONOMY-49936',
      '2026-08-15'::date, 'company',
      'earnings', 'CJ대한통운, 2Q 영업익 1016억…전년比 11.9％↓',
      '1코노미뉴스', '2026-08-11T05:21:00.000Z'::timestamptz,
      'https://www.1conomynews.co.kr/news/articleView.html?idxno=49936', '90c34bafc9b2e8424b9e907938602cd0120dd551fa2a588c6e8fc2fe40790b7e'
    ),
    (
    ...
    (
      'e9bb43c361916c1b45799d80557cc96c95192c38d07b85742ce922ba77497a29', 'MANUAL-GENEWS-20260518',
      '2026-08-15'::date, 'company',
      'sales_or_production', '현대글로비스, ''1만 대 벽'' 깼다… 1만800대 수송 가능한 세계 최대 자동차 운반선 전격 투입',
      '글로벌이코노믹', '2026-05-17T23:16:00.000Z'::timestamptz,
      'https://www.g-enews.com/article/Global-Biz/2026/05/2026051808144716870c8c1c064d_1', '417951bb341232d2aaafac2b9ccefdd9b5dd9530b39e658ceffae87d7e60a746'
    ),
    (
...
where run.run_key = 'selected-company-news-2026-08-15-deep-with-manual'
  ...
  if exists (
    ...
    join (
      values
        ...
        ('a91272017c63a2058a8924a14b4d9d2cfda87374781a5800681acdf18fb57a84', '90c34bafc9b2e8424b9e907938602cd0120dd551fa2a588c6e8fc2fe40790b7e'),
        ...
        ('e9bb43c361916c1b45799d80557cc96c95192c38d07b85742ce922ba77497a29', '417951bb341232d2aaafac2b9ccefdd9b5dd9530b39e658ceffae87d7e60a746'),
...
begin
  if exists (
    ...
    join (
      ...
      (
      'a91272017c63a2058a8924a14b4d9d2cfda87374781a5800681acdf18fb57a84', 'earnings',
      array['000120']::text[], 'CJ대한통운이 2026년 2분기 연결 기준 매출 3조3800억원, 영업이익 1016억원, 순이익 368억원을 기록했다고 밝혔다.',
      'CJ대한통운, 2분기 매출 3조3800억원·영업이익 1016억원', 'CJ대한통운, 2분기 매출 3조3800억원·영업이익 1016억원',
      '매출은 지난해보다 10.9% 늘었어요.', 'revenue_growth',
      '영업이익은 11.9% 줄었어요.', 'operating_profit_decline',
      '순이익은 368억원으로 36.8% 줄었어요.', 'net_income_decline',
      'business_performance',
      'event_education',
      '매출과 영업이익은 회사의 사업 성과를 보여주는 숫자예요.',
      '[{"term":"연결 기준","easyText":"회사가 거느린 다른 회사들 살림까지 합쳐서 센 것","treatment":"explained","sourceIds":["S1"]},{"term":"매출","easyText":"물건이나 서비스를 팔아서 들어온 돈 전부","treatment":"explained","sourceIds":["S1"]},{"term":"영업이익","easyText":"번 돈에서 쓴 돈을 빼고 남은 돈","treatment":"explained","sourceIds":["S2"]},{"term":"영업이익률","easyText":"판 돈 가운데 이익이 얼마나 되는지를 보여주는 비율","treatment":"explained","sourceIds":["S3"]},{"term":"순이익","easyText":"세금까지 다 내고 최종적으로 남은 돈","treatment":"explained","sourceIds":["S4"]},{"term":"전년 동기 대비","easyText":"지난해 같은 기간과 견줘 본 것","treatment":"explained","sourceIds":["S1"]}]'::jsonb
    ),
      (
      ...
      (
      'e9bb43c361916c1b45799d80557cc96c95192c38d07b85742ce922ba77497a29', 'sales_or_production',
      array['086280']::text[], '현대글로비스가 소형차 1만800대를 실을 수 있는 세계 최대 자동차 운반선 ''글로비스 리더호''를 투입해 상업 운항을 시작했다.',
      '현대글로비스, 자동차 1만800대 싣는 세계 최대 운반선 투입', '현대글로비스, 자동차 1만800대 싣는 세계 최대 운반선 투입',
      '배 이름은 글로비스 리더호예요.', 'ship_name',
      '길이 230m, 너비 40m 크기예요.', 'ship_size',
      '이전 세계 기록은 9100대였어요.', 'previous_record',
      'production_capacity',
      'event_education',
      '한 번에 실어 나를 수 있는 양은 회사가 할 수 있는 일의 크기와 연결돼요.',
      '[{"term":"자동차 운반선","easyText":"자동차만 잔뜩 싣고 바다를 건너는 배","treatment":"explained","sourceIds":["S1"]},{"term":"총톤수","easyText":"배가 얼마나 큰지를 나타내는 숫자","treatment":"explained","sourceIds":["S2"]},{"term":"데크","easyText":"배 안에서 차를 세워 두는 층","treatment":"explained","sourceIds":["S2"]},{"term":"상업 운항","easyText":"돈을 받고 짐을 실어 나르기 시작하는 것","treatment":"explained","sourceIds":["S1"]},{"term":"이중연료 추진 엔진","easyText":"기름 두 종류를 골라 쓸 수 있는 배 엔진","treatment":"explained","sourceIds":["S5"]}]'::jsonb
    ),
      (
...
join (
  values
    ...
    (
      'a91272017c63a2058a8924a14b4d9d2cfda87374781a5800681acdf18fb57a84', 'S1', 1::smallint,
      '올해 2분기 연결 기준 매출은 3조3800억원으로 전년 동기 대비 10.9% 증가했다.', 'ba582dec3bb3b80c97cd0ed08b99a24afc374726bff54cbead04c857ce677374',
      true, true
    ),
    (
      'a91272017c63a2058a8924a14b4d9d2cfda87374781a5800681acdf18fb57a84', 'S2', 2::smallint,
      '영업이익은 1016억원으로 같은 기간 11.9% 감소했다.', '360a4182d2aabb9e60f02adb2d875665cf59d396a83d15ecc5c55d76179702b0',
      true, false
    ),
    (
      'a91272017c63a2058a8924a14b4d9d2cfda87374781a5800681acdf18fb57a84', 'S3', 3::smallint,
      '영업이익률은 지난해 2분기 3.8%에서 올해 2분기 3%로 0.8%포인트 하락했다.', 'b86e34fdf53d42fdf4fc482fbb1841063053e4e5b756235aeb6a66927a4c6f90',
      true, false
    ),
    (
      'a91272017c63a2058a8924a14b4d9d2cfda87374781a5800681acdf18fb57a84', 'S4', 4::smallint,
      '2분기 순이익은 368억원으로 전년 동기보다 36.8% 줄었다.', '58e01eaf124feadc39f2e16dc92b349fe26fc258a233e0c0713db68d188a5ec2',
      true, false
    ),
    (
      'a91272017c63a2058a8924a14b4d9d2cfda87374781a5800681acdf18fb57a84', 'S5', 5::smallint,
      '오네부문의 2분기 매출은 9848억원으로 전년 동기 대비 8.5% 증가했지만 영업이익은 409억원으로 10.7% 감소했다.', '09bc857e558024f1b7684d07dada79f09d915c11c6e195b364743bc0ce588561',
      true, false
    ),
    (
      'a91272017c63a2058a8924a14b4d9d2cfda87374781a5800681acdf18fb57a84', 'S6', 6::smallint,
      'CL부문의 2분기 매출은 9001억원으로 전년 동기 대비 8% 증가했다.', '136fcbd310a048ca28a62bee2123bf585f5810b18063d7d3592515ec1d31e8e4',
      true, false
    ),
    (
      'a91272017c63a2058a8924a14b4d9d2cfda87374781a5800681acdf18fb57a84', 'S7', 7::smallint,
      '건설부문의 2분기 매출은 2891억원으로 전년 동기 대비 41.2% 증가했으나 영업이익은 5억원에 그치며 86.8% 급감했다.', 'b9bfd315601564297ac7f7052dfd88a2ac642607eece9f338c8a8c451fc0592d',
      true, false
    ),
    (
    ...
    (
      'e9bb43c361916c1b45799d80557cc96c95192c38d07b85742ce922ba77497a29', 'S1', 1::smallint,
      '현대글로비스는 최대 1만800대의 소형차를 수송할 수 있는 초대형 자동차 운반선 ''글로비스 리더(Glovis Leader)호''를 글로벌 오션 노선에 본격 투입하고 명명식을 거쳐 상업 운항을 개시했다.', 'bdcf0f27b1cb79a36433f458580ddead09fee5885496eb0c5e1096e2c27712c0',
      true, true
    ),
    (
      'e9bb43c361916c1b45799d80557cc96c95192c38d07b85742ce922ba77497a29', 'S2', 2::smallint,
      '선체 길이 230m, 너비 40m, 총톤수 10만2590톤에 달하며 내부에는 총 14개 층의 차량 적재 데크를 갖추고 있다.', 'ad44ff93e2848b758ccb212af93e93d00ac865ca4aec540da39e297b1c136ba2',
      true, false
    ),
    (
      'e9bb43c361916c1b45799d80557cc96c95192c38d07b85742ce922ba77497a29', 'S3', 3::smallint,
      '기존 세계 기록이었던 노르웨이 회그 오토라이너스(Höegh Autoliners)사 ''회그 오로라호''의 수송 용량(9100대)을 약 19% 이상 전격 경신 한 수치다.', '592b05e0d46411d7f91da1a315f7327141e2bdc0db569008ff6f163da315c0c9',
      true, false
    ),
    (
      'e9bb43c361916c1b45799d80557cc96c95192c38d07b85742ce922ba77497a29', 'S4', 4::smallint,
      '글로비스 리더호는 세계적인 국영 조선 그룹인 중국선박집단(CSSC) 산하 ''광저우 조선소(Guangzhou Shipyard International·GSI)''가 건조를 맡았다.', 'fac2edbc5ba67e7c1162b4b5e2e4ab972f893a65e0123ac2c575b040a8049379',
      true, false
    ),
    (
      'e9bb43c361916c1b45799d80557cc96c95192c38d07b85742ce922ba77497a29', 'S5', 5::smallint,
      '이 선박의 핵심 심장부는 액화천연가스(LNG)와 기존 선박유를 모두 사용할 수 있는 친환경 이중연료(Dual-Fuel) 추진 엔진 이다.', '17f47e5bc7392bd9e30505398198ac4fda1d3424997599f6df4f8dec733c2713',
      true, false
    ),
    (
      'e9bb43c361916c1b45799d80557cc96c95192c38d07b85742ce922ba77497a29', 'S6', 6::smallint,
      '현대글로비스는 이번 호를 시작으로 오는 2027년까지 동급의 자매선들을 순차적으로 추가 투입해, 2030년까지 총 128척의 대규모 카캐리어 선단을 구축하겠다는 공격적인 로드맵을 확정했다.', '65cacbd00ec5c4d6fe419426966107e6126e60842df50cc661c0bc2a207cd6ba',
      true, false
    ),
    (
...
join (
  values
    ...
    ('a91272017c63a2058a8924a14b4d9d2cfda87374781a5800681acdf18fb57a84', '000120'),
    ('89da34ca44ad1f955de66d6246b13d942dd6326420c4b7a6041a1c66620e898a', '011200'),
    ('e9bb43c361916c1b45799d80557cc96c95192c38d07b85742ce922ba77497a29', '086280'),
...
join (
  values
    ...
    ('a91272017c63a2058a8924a14b4d9d2cfda87374781a5800681acdf18fb57a84', 'headline', 'S1'),
    ('a91272017c63a2058a8924a14b4d9d2cfda87374781a5800681acdf18fb57a84', 'headline', 'S2'),
    ('a91272017c63a2058a8924a14b4d9d2cfda87374781a5800681acdf18fb57a84', 'home_summary', 'S1'),
    ('a91272017c63a2058a8924a14b4d9d2cfda87374781a5800681acdf18fb57a84', 'home_summary', 'S2'),
    ('a91272017c63a2058a8924a14b4d9d2cfda87374781a5800681acdf18fb57a84', 'summary_line_1', 'S1'),
    ('a91272017c63a2058a8924a14b4d9d2cfda87374781a5800681acdf18fb57a84', 'summary_line_2', 'S2'),
    ('a91272017c63a2058a8924a14b4d9d2cfda87374781a5800681acdf18fb57a84', 'summary_line_3', 'S4'),
    ('a91272017c63a2058a8924a14b4d9d2cfda87374781a5800681acdf18fb57a84', 'price_connection', 'S1'),
    ('a91272017c63a2058a8924a14b4d9d2cfda87374781a5800681acdf18fb57a84', 'price_connection', 'S2'),
    ...
    ('e9bb43c361916c1b45799d80557cc96c95192c38d07b85742ce922ba77497a29', 'headline', 'S1'),
    ('e9bb43c361916c1b45799d80557cc96c95192c38d07b85742ce922ba77497a29', 'home_summary', 'S1'),
    ('e9bb43c361916c1b45799d80557cc96c95192c38d07b85742ce922ba77497a29', 'summary_line_1', 'S1'),
    ('e9bb43c361916c1b45799d80557cc96c95192c38d07b85742ce922ba77497a29', 'summary_line_2', 'S2'),
    ('e9bb43c361916c1b45799d80557cc96c95192c38d07b85742ce922ba77497a29', 'summary_line_3', 'S3'),
    ('e9bb43c361916c1b45799d80557cc96c95192c38d07b85742ce922ba77497a29', 'price_connection', 'S1'),
    ('e9bb43c361916c1b45799d80557cc96c95192c38d07b85742ce922ba77497a29', 'price_connection', 'S3'),
...
where status = 'draft'
  and article_id in (
    ...
    where source_key in (
      ...
      'a91272017c63a2058a8924a14b4d9d2cfda87374781a5800681acdf18fb57a84',
      '89da34ca44ad1f955de66d6246b13d942dd6326420c4b7a6041a1c66620e898a',
      'e9bb43c361916c1b45799d80557cc96c95192c38d07b85742ce922ba77497a29',
