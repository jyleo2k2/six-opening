  componentDidMount(){
    ...
    this.setState(s => Object.assign({}, s, saved ? { acc:saved.acc, records:saved.records, sellRecords:saved.sellRecords || [], events:saved.events || [], badges:saved.badges || 0, seq:saved.seq, watchlist:saved.watchlist || [] } : {}, { reasonOrder: order }), () => this.notifyChatContext());
