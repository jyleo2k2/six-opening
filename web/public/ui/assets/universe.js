...
(function () {
  ...
  const raw = [
    ['005930', "삼성전자",                 "semi",     "휴대폰이랑 반도체를 만들어요",                         257000, 7.31],
    ['000660', "SK하이닉스",               "semi",     "기억을 저장하는 반도체를 만들어요",                     1517000, 6.46],
    ['402340', "SK스퀘어",                "semi",     "반도체랑 통신 회사들을 갖고 있어요",                    1032000, 9.21],
    ['066570', "LG전자",                 "semi",     "TV랑 냉장고, 세탁기를 만들어요",                      208000, 14.47],
    ['259960', "크래프톤",                 "game",     "배틀그라운드 게임을 만들어요",                         236500, -3.07],
    ['036570', "NC",                   "game",     "리니지라는 게임을 만들어요",                          249500, -2.35],
    ['251270', "넷마블",                  "game",     "휴대폰으로 하는 게임을 만들어요",                        40100, -1.11],
    ['192080', "더블유게임즈",             "game",     "모바일 게임을 만들어 세계에 서비스해요",               61100, -1.45],
    ['003230', "삼양식품",                 "food",     "불닭볶음면을 만들어요",                            1215000, -3.11],
    ['271560', "오리온",                  "food",     "초코파이를 만들어요",                              132600, -2.5],
    ['097950', "CJ제일제당",               "food",     "햇반이랑 만두를 만들어요",                           186800, -0.64],
    ['004370', "농심",                   "food",     "신라면을 만들어요",                               389000, -1.64],
    ['005380', "현대차",                  "auto",     "자동차를 만들어요",                               412500, 2.36],
    ['000270', "기아",                   "auto",     "자동차를 만들어요",                               136400, 1.56],
    ['012330', "현대모비스",                "auto",     "자동차 부품을 만들어요",                            506000, 2.12],
    ['352820', "하이브",                  "enter",    "BTS가 있는 회사예요",                            179900, -0.22],
    ['041510', "에스엠",                  "enter",    "NCT랑 에스파가 있어요",                            76000, -0.39],
    ['035900', "JYP Ent.",             "enter",    "트와이스랑 스트레이키즈가 있어요",                        45750, -1.72],
    ['122870', "와이지엔터",                "enter",    "블랙핑크가 있는 회사예요",                            42650, -1.5],
    ['090430', "아모레퍼시픽",               "beauty",   "화장품을 만들어요",                               137150, -0.11],
    ['051900', "LG생활건강",               "beauty",   "화장품이랑 샴푸를 만들어요",                          316500, -0.63],
    ['278470', "에이피알",                 "beauty",   "집에서 쓰는 피부 기계를 만들어요",                      391500, 1.56],
    ['483650', "달바글로벌",                "beauty",   "얼굴에 바르는 화장품을 만들어요",                       255500, 3.86],
    ['003490', "대한항공",                 "air",      "비행기로 사람을 실어 날라요",                          26700, 0.19],
    ['020560', "아시아나항공",               "air",      "비행기를 타고 여행을 도와줘요",                          7260, 1.97],
    ['180640', "한진칼",                  "air",      "대한항공을 갖고 있는 회사예요",                        120000, 1.78],
    ['329180', "HD현대중공업",              "ship",     "배랑 엔진을 만들어요",                             494000, -1.79],
    ['009540', "HD한국조선해양",             "ship",     "아주 큰 배를 만들어요",                            379500, -4.65],
    ['042660', "한화오션",                 "ship",     "배랑 잠수함을 만들어요",                             89600, 0.67],
    ['010140', "삼성중공업",                "ship",     "바다에서 쓰는 큰 배를 만들어요",                        22000, 0.92],
    ['012450', "한화에어로스페이스",            "defense",  "비행기 엔진이랑 무기를 만들어요",                      1134000, 3.28],
    ['079550', "LIG디펜스앤에어로",           "defense",  "미사일 같은 걸 만들어요",                           759000, -0.13],
    ['047810', "한국항공우주",               "defense",  "전투기랑 헬기를 만들어요",                           139200, 2.73],
    ['064350', "현대로템",                 "defense",  "기차도 만들고 전차도 만들어요",                        144000, 1.84],
    ['015760', "한국전력",                 "energy",   "전기를 만들어서 보내줘요",                            35800, 1.7],
    ['010950', "S-Oil",                "energy",   "자동차에 넣는 기름을 만들어요",                        143400, 1.27],
    ['078930', "GS",                   "energy",   "기름이랑 편의점 회사를 갖고 있어요",                      99400, 1.95],
    ['096770', "SK이노베이션",              "energy",   "기름이랑 배터리를 만들어요",                          125350, 1.01],
    ['047050', "포스코인터내셔널",             "logi",     "외국에서 가스랑 곡식을 사고팔아요",                       54400, -2.51],
    ['004170', "신세계",                  "retail",   "신세계백화점을 운영해요",                            400500, -6.53],
    ['282330', "BGF리테일",               "retail",   "CU 편의점을 운영해요",                            147900, -1.73],
    ['021240', "코웨이",                  "retail",   "정수기랑 공기청정기를 빌려줘요",                         96900, -0.72],
    ['089860', "롯데렌탈",                 "retail",   "자동차를 빌려주는 회사예요",                           43450, -3.44],
    ['000120', "CJ대한통운",               "logi",     "택배를 배달해줘요",                                74400, -3.88],
    ['011200', "HMM",                  "logi",     "큰 배로 짐을 실어 날라요",                           21475, -0.81],
    ['086280', "현대글로비스",               "logi",     "자동차를 배로 실어 날라요",                          201500, 0],
    ['105560', "KB금융",                 "bank",     "은행에서 돈을 맡아줘요",                            166900, 0.18],
    ['055550', "신한지주",                 "bank",     "은행이랑 카드를 운영해요",                           105500, 0.96],
    ['086790', "하나금융지주",               "bank",     "은행에서 돈을 빌려주기도 해요",                        128800, 0.86],
    ['316140', "우리금융지주",               "bank",     "은행을 운영하는 회사예요",                            33350, -1.33],
    ['039490', "키움증권",                 "bank",     "주식 사고파는 걸 도와주는 회사예요",                     303000, 1],
  ];
  ...
  const brands = {
    ...
    '192080': { cat: 'GAMING', color: '#528dd6', dark: true },
  ...
  const tints = {
    ...
    '192080': { bg: '#cbdefc', accent: '#5a8ee2' },
