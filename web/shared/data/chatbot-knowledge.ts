...
export const CHATBOT_KNOWLEDGE: readonly ChatbotKnowledgeEntry[] = [
  ...
  { id: "current-price", kind: "glossary", triggers: ["현재가"], answer: "현재가는 지금 화면에 표시된 최근 거래 가격이에요. 시간이 지나면 달라질 수 있어요.", explainScript: GLOSSARY_EXPLAIN_SCRIPTS["current-price"], status: reviewed },
  ...
  { id: "limit-order", kind: "glossary", triggers: ["지정가"], answer: "지정가는 내가 정한 가격에만 주문이 되도록 하는 방법이에요. 그 가격에 거래 상대가 없으면 바로 체결되지 않을 수 있어요.",
    ...
    status: reviewed },
  { id: "quantity", kind: "glossary", triggers: ["수량", "몇 주"], answer: "수량은 사고팔 주식의 개수예요. 한 주 가격과 곱하면 대략의 거래 금액을 확인할 수 있어요.", explainScript: GLOSSARY_EXPLAIN_SCRIPTS.quantity, status: reviewed },
  { id: "estimated-amount", kind: "glossary", triggers: ["예상 금액"], answer: "예상 금액은 주문 수량과 가격으로 계산한 돈이에요. 주문을 확정하기 전 최종 금액을 다시 확인해 주세요.", explainScript: GLOSSARY_EXPLAIN_SCRIPTS["estimated-amount"], status: reviewed },
  { id: "evaluation-amount", kind: "glossary", triggers: ["평가금액"], answer: "평가금액은 지금 가지고 있는 주식이 현재 가격으로 얼마인지 보여주는 금액이에요. 아직 팔지 않았다면 가격에 따라 바뀔 수 있어요.", explainScript: GLOSSARY_EXPLAIN_SCRIPTS["evaluation-amount"], status: reviewed },
  ...
  { id: "average-price", kind: "glossary", triggers: ["평균 매수가", "평균매수가"], answer: "평균 매수가는 같은 종목을 여러 번 샀을 때 한 주당 평균으로 얼마에 샀는지 보여주는 가격이에요.", explainScript: GLOSSARY_EXPLAIN_SCRIPTS["average-price"], status: reviewed },
  { id: "sector", kind: "glossary", triggers: ["업종"], answer: "업종은 비슷한 일을 하는 회사들을 묶은 이름이에요. 예를 들어 게임 회사나 식품 회사처럼 나눌 수 있어요.", explainScript: GLOSSARY_EXPLAIN_SCRIPTS.sector, status: reviewed },
