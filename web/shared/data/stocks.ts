...
export const STOCKS: readonly StockEducation[] = [
  ...
  { id: "KRX:036570", symbol: "036570", name: "엔씨소프트", searchAliases: ["NC", "NCSoft", "엔씨"], sector: "game", market: "KOSPI", companySummary: pendingDescription, offerings: pendingDetails, everydayTouchpoints: pendingDetails, status: draft },
  ...
  { id: "KRX:192080", symbol: "192080", name: "더블유게임즈", searchAliases: ["DoubleGame", "더블유게임"], sector: "game", market: "KOSPI", companySummary: pendingDescription, offerings: pendingDetails, everydayTouchpoints: pendingDetails, status: draft },
  ...
  // 표시 이름은 짧은 공식 약칭 "LIG D&A" 하나로 통일한다(카드 폭에 풀네임이 잘렸다).
  // 별칭에는 풀네임 한글·영문과 옛 이름(LIG넥스원)을 함께 둔다 — 뉴스 원문이 아직 옛 이름을 쓴다.
  { id: "KRX:079550", symbol: "079550", name: "LIG D&A", searchAliases: ["LIG디펜스앤에어로스페이스", "LIG 디펜스앤에어로스페이스", "LIG Defense&Aerospace", "LIG Defense & Aerospace", "LIG넥스원", "LIG 넥스원", "LIG Nex1", "엘아이지넥스원"], sector: "defense", market: "KOSPI", companySummary: pendingDescription, offerings: pendingDetails, everydayTouchpoints: pendingDetails, status: draft },
  { id: "KRX:047810", symbol: "047810", name: "한국항공우주", searchAliases: ["KAI", "한국 항공 우주", "카이"], sector: "defense", market: "KOSPI", companySummary: pendingDescription, offerings: pendingDetails, everydayTouchpoints: pendingDetails, status: draft },
  ...
  { id: "KRX:097950", symbol: "097950", name: "CJ제일제당", searchAliases: ["CJ 제일제당", "씨제이제일제당"], sector: "food", market: "KOSPI", companySummary: pendingDescription, offerings: pendingDetails, everydayTouchpoints: pendingDetails, status: draft },
  ...
  { id: "KRX:010950", symbol: "010950", name: "S-OIL", searchAliases: ["에쓰오일", "에스오일", "S Oil"], sector: "energy", market: "KOSPI", companySummary: pendingDescription, offerings: pendingDetails, everydayTouchpoints: pendingDetails, status: draft },
  ...
  { id: "KRX:096770", symbol: "096770", name: "SK이노베이션", searchAliases: ["SK 이노베이션", "SK Innovation", "에스케이이노베이션"], sector: "energy", market: "KOSPI", companySummary: pendingDescription, offerings: pendingDetails, everydayTouchpoints: pendingDetails, status: draft },
  { id: "KRX:047050", symbol: "047050", name: "포스코인터내셔널", searchAliases: ["POSCO인터내셔널", "POSCO International", "포스코"], sector: "logistics", market: "KOSPI", companySummary: pendingDescription, offerings: pendingDetails, everydayTouchpoints: pendingDetails, status: draft },
  ...
  { id: "KRX:035900", symbol: "035900", name: "JYP Ent.", searchAliases: ["JYP", "JYP엔터", "JYP Ent", "제이와이피", "제이와이피엔터", "제이와이피엔터테인먼트"], sector: "entertainment", market: "KOSDAQ", companySummary: pendingDescription, offerings: pendingDetails, everydayTouchpoints: pendingDetails, status: draft },
  { id: "KRX:122870", symbol: "122870", name: "와이지엔터테인먼트", searchAliases: ["YG", "YG엔터", "와이지", "와이지엔터"], sector: "entertainment", market: "KOSDAQ", companySummary: pendingDescription, offerings: pendingDetails, everydayTouchpoints: pendingDetails, status: draft },
  ...
  { id: "KRX:282330", symbol: "282330", name: "BGF리테일", searchAliases: ["BGF 리테일", "비지에프리테일"], sector: "retail", market: "KOSPI", companySummary: pendingDescription, offerings: pendingDetails, everydayTouchpoints: pendingDetails, status: draft },
  { id: "KRX:105560", symbol: "105560", name: "KB금융", searchAliases: ["KB 금융", "케이비금융"], sector: "finance", market: "KOSPI", companySummary: pendingDescription, offerings: pendingDetails, everydayTouchpoints: pendingDetails, status: draft },
  { id: "KRX:039490", symbol: "039490", name: "키움증권", searchAliases: ["Kiwoom", "키움", "키움 증권", "영웅문", "Kiwoom Securities"], sector: "finance", market: "KOSPI", companySummary: pendingDescription, offerings: pendingDetails, everydayTouchpoints: pendingDetails, status: draft },
  ...
  { id: "KRX:402340", symbol: "402340", name: "SK스퀘어", searchAliases: ["SK 스퀘어", "SK Square", "에스케이스퀘어"], sector: "semiconductor", market: "KOSPI", companySummary: pendingDescription, offerings: pendingDetails, everydayTouchpoints: pendingDetails, status: draft },
  ...
  { id: "KRX:089860", symbol: "089860", name: "롯데렌탈", searchAliases: ["Lotte Rental"], sector: "retail", market: "KOSPI", companySummary: pendingDescription, offerings: pendingDetails, everydayTouchpoints: pendingDetails, status: draft },
  ...
  { id: "KRX:329180", symbol: "329180", name: "HD현대중공업", searchAliases: ["HD 현대중공업", "에이치디현대중공업", "현대중공업"], sector: "shipbuilding", market: "KOSPI", companySummary: pendingDescription, offerings: pendingDetails, everydayTouchpoints: pendingDetails, status: draft },
  { id: "KRX:009540", symbol: "009540", name: "HD한국조선해양", searchAliases: ["HD 한국조선해양", "에이치디한국조선해양", "한국조선해양"], sector: "shipbuilding", market: "KOSPI", companySummary: pendingDescription, offerings: pendingDetails, everydayTouchpoints: pendingDetails, status: draft },
  ...
  { id: "KRX:483650", symbol: "483650", name: "달바글로벌", searchAliases: ["달바 글로벌", "d'Alba Global", "달바"], sector: "cosmetics", market: "KOSPI", companySummary: pendingDescription, offerings: pendingDetails, everydayTouchpoints: pendingDetails, status: draft },
  { id: "KRX:051900", symbol: "051900", name: "LG생활건강", searchAliases: ["LG 생활건강", "엘지생활건강"], sector: "cosmetics", market: "KOSPI", companySummary: pendingDescription, offerings: pendingDetails, everydayTouchpoints: pendingDetails, status: draft },
];
